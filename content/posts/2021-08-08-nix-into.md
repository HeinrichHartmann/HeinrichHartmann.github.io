...
In the following sections we will create four different build variant that realize our goal following
...
If you are only interested in using the results, you can direcly skip to the [GitHub repository](https://github.com/HeinrichHartmann/emacs-head.nix).
