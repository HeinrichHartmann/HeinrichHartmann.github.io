...
exact dependencies needed are made available in a build, dev or runtime environment. The design and
some similarity with git and aims to solve similar problems than docker. From an abstract
