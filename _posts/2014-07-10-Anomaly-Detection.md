...
3. Let $b,m \in \IR$ be real numbers, then
...
![png](CusumMethod_files/CusumMethod_1_0.png)
...
$$ \hat{\theta}= \text{arg-max} \{ P_\theta[y] \,|\, \theta \in \Theta \}. $$
...
![png](CusumMethod_files/CusumMethod_3_0.png)
...
$$
\Lambda
= \frac{max \{ P_{\theta'}[y] \,|\, \theta' \in \Theta_1 \}}{max \{
P_{\theta}[y]  \,|\, \theta \in \Theta_0 \} }
...
![png](CusumMethod_files/CusumMethod_5_0.png)



![png](CusumMethod_files/CusumMethod_5_1.png)
...
![png](CusumMethod_files/CusumMethod_5_3.png)
...
![png](CusumMethod_files/CusumMethod_7_0.png)
...
which is known as the CUSUM method.
    ...
    [<matplotlib.lines.Line2D at 0x4c4e2d0>]




![png](CusumMethod_files/CusumMethod_9_1.png)
